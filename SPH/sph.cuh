...
#define SMOOTHING 0.15f      // Adjusted smoothing radius for sufficient neighbors
...
//Number of grid cells along X / Y in a 2×2 box, ceil(2 / H)
#define GRID_SIZE_X  ((int)(2.0f/SMOOTHING + 0.999999f))
#define GRID_SIZE_Y  GRID_SIZE_X
